...
import favoriteController from "../controlers/favorite.controller.js";
...
router.post(
    "/signup",
    body("username")
        .exists().withMessage("username is requied")
    ...
    body("password")
        .exists().withMessage("password is requied")
        .isLength({ min: 8 }).withMessage("password minimum 8 characters"),
    body("confirmPassword")
        .exists().withMessage("confirmPassword is requied")
        .isLength({ min: 8 }).withMessage("password minimum 8 characters")
        .custom((value, { req }) => {
    ...
    body("displayName")
        .exists().withMessage("displayName is requied")
        .isLength({ min: 8 }).withMessage("username minimum 8 characters"),
...
router.post(
    ...
    body("mediaId")
        ...
        .isLength({ min: 1 }).withMessage("mediaId can nt be empty"),
    body("mediaTitle")
